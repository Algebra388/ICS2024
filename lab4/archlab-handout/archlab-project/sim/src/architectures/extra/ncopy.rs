...
// ID:2300012938
// Name:张乐天
//思路：加入iaddq以及加入mrmovq与rmmovq的加载转发。
crate::define_stages! {
    FetchStage f {
        pred_pc: u64 = 0
    }
...
bool set_cc = (E.icode == OPQ || E.icode == IOPQ) &&
...
u64 e_valA = [
    E.icode == RMMOVQ && E.srcA == M.dstM : m_valM;
    1 : E.valA    // Pass valA through stage
];
...
bool temp = (E.icode == PUSHQ && E.dstM in { d_srcA, d_srcB }) || 
(E.icode == MRMOVQ && (E.dstM == d_srcB || (E.dstM == d_srcA && D.icode != RMMOVQ))) ;
