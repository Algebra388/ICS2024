/* 
 * myterm1 - Shell lab test program. 
 *
 ...
 * 
 * When received sigterm it prints out some message and again synchronizes
 * with the shell driver and quit after it.
 * 
 * 
 * Warning: cannot be used directly without your shell driver
 */
#include <stdio.h>
#include <unistd.h>
#include <stdlib.h>
